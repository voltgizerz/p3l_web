...
class Penjualan_Produk_model extends CI_Model
{
    ...
    {
        return $this->db->count_all('data_transaksi_penjualan_produk');
    }

    public function getDataPenjualanProdukAdmin($limit, $start)
    {
    ...
    public function cariPenjualanProduk($berdasarkan, $yangdicari)
    {
        ...
        switch ($berdasarkan) {
            case "":
                ...
                $this->db->order_by("id_transaksi_penjualan_produk", "desc");
                $this->db->limit(10); 
                break;
