                    ...
                    <?php foreach ($dataDetailPenjualanProduk as $sm) : ?>
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a href="<?= base_url(); ?>kasir/updateDetailPembayaranProduk/<?= $sm['id_detail_penjualan_produk']; ?>" class="badge badge-primary mb-3" data-toggle="modal" data-target="#editSubMenuModal<?= $sm['id_detail_penjualan_produk']; ?>">EDIT</a>
                                <a href="<?= base_url(); ?>kasir/hapusDetailPembayaranProduk/<?= $sm['id_detail_penjualan_produk']; ?>" class="badge badge-danger mb-3">DELETE</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
...
<div class="modal fade" id="newSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="#newSubMenuModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url(); ?>kasir/detail_penjualan_produk/<?= $id_penjualan; ?>" method="post">
...
<?php foreach ($dataDetailPenjualanProduk as $sm) : ?>
    <!-- Modal edit -->
    <div class="modal fade" id="editSubMenuModal<?= $sm['id_detail_penjualan_produk']; ?>" tabindex="-1" role="dialog" aria-labelledby="#editSubMenuModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url(); ?>kasir/updateDetailPembayaranProduk/<?= $sm['id_detail_penjualan_produk']; ?>" method="post">

                    <div class="modal-body">
                        <div class="form-group">
                            <input hidden type="text" class="form-control" value="<?= $sm['id_detail_penjualan_produk']; ?>" id="id" name="id">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="jumlah_produk" name="jumlah_produk" placeholder="Jumlah Pengadaan" value="<?= $sm['jumlah_produk']; ?>">
                        </div>
