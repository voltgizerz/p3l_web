                ...
                <?php foreach ($dataPengadaan as $sm) : ?>
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a href="<?= base_url(); ?>admin/detail_pengadaan/<?= $sm['id_pengadaan']; ?>" class="badge badge-info mb-3">INFO</a>
                        </td>
                        <td style="text-align:center;">
                            ...
                            <?php if ($sm['total_pengadaan'] == 0) : ?>
                                Belum Ada Produk
                            <?php else : ?>
                                <a href="<?= base_url(); ?>laporan/index/<?= $sm['id_pengadaan']; ?>" target="_blank" class="badge badge-warning mb-3" style="visibility: <?= $hide ?>"><i class="fa fa-print"></i>
                                    CETAK</a>
                            <?php endif; ?>
                        ...
                        <td style="text-align:center;">
                            ...
                            <a href="<?= base_url(); ?>admin/updatePengadaan/<?= $sm['id_pengadaan']; ?>" class="badge badge-primary mb-3" data-toggle="modal" data-target="#editSubMenuModal<?= $sm['id_pengadaan']; ?>" style="visibility: <?= $hide ?>">EDIT</a>
                            <a href="<?= base_url(); ?>admin/hapusPengadaan/<?= $sm['id_pengadaan']; ?>" class="badge badge-danger mb-3 style=" style="visibility: <?= $hide ?>">DELETE</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
...
<?php foreach ($dataPengadaan as $sm) : ?>
    <!-- Modal edit -->
    <div class="modal fade" id="editSubMenuModal<?= $sm['id_pengadaan']; ?>" tabindex="-1" role="dialog" aria-labelledby="#editSubMenuModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url(); ?>admin/updatePengadaan/<?= $sm['id_pengadaan']; ?>" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input hidden type="text" class="form-control" value="<?= $sm['id_pengadaan']; ?>" id="id" name="id">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="kode" name="kode" value="<?= $sm['kode_pengadaan']; ?>" placeholder="Kode Pengadaan" readonly>
                        </div>
                        <div class="form-group">
                            <select class="form-control" id="pilih_supplier" name="pilih_supplier">
                                <option value="">Pilih Supplier</option>
                        ...
                        <div class="form-group">
                            <select class="form-control" id="status" name="status">
                                ...
                                <option <?php if ($sm['status_pengadaan'] == 'Belum Diterima') {
                                            echo ("selected");
                                        } ?>>Belum
                                    Diterima
                                </option>
                                <option <?php if ($sm['status_pengadaan'] == 'Sudah Diterima') {
                                            echo ("selected");
                                        } ?>>Sudah
                                    Diterima
                                </option>
