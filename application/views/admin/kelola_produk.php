            ...
            <tbody>
                ...
                <?php foreach ($dataProduk as $sm) : ?>
                    <tr>
                        ...
                        <td style="text-align:center;"><img style="border:5px solid white" height=" 100" width="100" src="<?= base_url(); ?><?= $sm['gambar_produk'] ?>" </td> <td style="text-align:center;"><?= $sm['nama_produk'] ?></td>
                        ...
                        <td style="text-align:center;">
                            <a href="<?= base_url(); ?>admin/updateProduk/<?= $sm['id_produk']; ?>" class="badge badge-primary mb-3" data-toggle="modal" data-target="#editSubMenuModal<?= $sm['id_produk']; ?>">EDIT</a>
                            <a href="<?= base_url(); ?>admin/hapusProduk/<?= $sm['id_produk']; ?>" class="badge badge-danger mb-3">DELETE</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/kelola_produk'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="number" class="form-control" id="stok_minimal" name="stok_minimal" placeholder="Stok Minimal Produk">
                    </div>
                </div>
...
<?php foreach ($dataProduk as $sm) : ?>
    <!-- Modal edit -->
    <div class="modal fade" id="editSubMenuModal<?= $sm['id_produk']; ?>" tabindex="-1" role="dialog" aria-labelledby="#editSubMenuModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url(); ?>admin/updateProduk/<?= $sm['id_produk']; ?>" method="post" enctype="multipart/form-data">

                    <div class="modal-body">
                        <div class="form-group">
                            <input hidden type="text" class="form-control" value="<?= $sm['id_produk']; ?>" id="id" name="id">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="nama" name="nama" value="<?= $sm['nama_produk']; ?>" placeholder="Nama Produk">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="number" class="form-control" id="harga" name="harga" value="<?= $sm['harga_produk']; ?>" placeholder="Harga Produk">
                        </div>

                        <div class="form-group">
                            <input type="number" class="form-control" id="stok" name="stok" value="<?= $sm['stok_produk']; ?>" placeholder="Stok Produk">
                        </div>

                        <div class="form-group">
                            <input type="number" class="form-control" id="stok_minimal" value="<?= $sm['stok_minimal_produk']; ?>" name="stok_minimal" placeholder="Stok Minimal Produk">
                        </div>
