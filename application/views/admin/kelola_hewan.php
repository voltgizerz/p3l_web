            ...
            <tbody>
                ...
                <?php foreach ($dataHewan as $sm) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url(); ?>admin/updateHewan/<?= $sm['id_hewan']; ?>" class="badge badge-primary mb-3" data-toggle="modal" data-target="#editSubMenuModal<?= $sm['id_hewan']; ?>">EDIT</a>
                            <a href="<?= base_url(); ?>admin/hapusHewan/<?= $sm['id_hewan']; ?>" class="badge badge-danger mb-3">DELETE</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
...
<?php foreach ($dataHewan as $sm) : ?>
    <!-- Modal edit -->
    <div class="modal fade" id="editSubMenuModal<?= $sm['id_hewan']; ?>" tabindex="-1" role="dialog" aria-labelledby="#editSubMenuModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url(); ?>admin/updateHewan/<?= $sm['id_hewan']; ?>" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="nama" name="nama" value="<?= $sm['nama_hewan']; ?>" placeholder="Nama Jenis Hewan">
                        </div>

                        <div class="form-group">
                            <input type="date" class="form-control" id="tangal" name="tanggal" value="<?= $sm['tanggal_lahir_hewan']; ?>" placeholder="Tanggal Lahir (YYYY-MM-DD)">
                        </div>
                        <div class="form-group">
                            <select class="form-control" id="pilih_customer" name="pilih_customer">
                                <option>Pilih customer</option>
