        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/kelola_customer'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="tanggal_lahir_customer" name="tanggal_lahir_customer" placeholder="Tanggal Lahir">
                    </div>
                    <div class="form-group">
            ...
            <form action="<?= base_url(); ?>admin/updateCustomer/<?= $sm['id_customer']; ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="tanggal_lahir_customer" name="tanggal_lahir_customer" value="<?= $sm['tanggal_lahir_customer']; ?>" placeholder="Tanggal Lahir">
                        </div>
                        <div class="form-group">
