...
<div class="row">
    <div class="col-lg ml-3 mr-3">
        ...
        <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newSubMenuModal">TAMBAH JASA LAYANAN
            PENJUALAN</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        <a href="<?=base_url();?>cs/updateDetailPenjualanLayanan/<?=$sm['id_detail_penjualan_jasa_layanan'];?>"
                            class="badge badge-primary mb-3" data-toggle="modal"
                            data-target="#editSubMenuModal<?=$sm['id_detail_penjualan_jasa_layanan'];?>">EDIT</a>
                        <a href="<?=base_url();?>cs/hapusDetailPenjualanLayanan/<?=$sm['id_detail_penjualan_jasa_layanan'];?>"
...
<div class="modal fade" id="newSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="#newSubMenuModal"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url();?>cs/detail_penjualan_layanan/<?=$id_penjualan;?>" method="post">
...
<?php foreach ($dataDetailPenjualanLayanan as $sm): ?>
<!-- Modal edit -->
<div class="modal fade" id="editSubMenuModal<?=$sm['id_detail_penjualan_jasa_layanan'];?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url();?>cs/updateDetailPenjualanLayanan/<?=$sm['id_detail_penjualan_jasa_layanan'];?>"
                method="post">

                <div class="modal-body">
                    <div class="form-group">
                        <input hidden type="text" class="form-control"
                            value="<?=$sm['id_detail_penjualan_jasa_layanan'];?>" id="id" name="id">
                    </div>
