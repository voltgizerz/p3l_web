                    ...
                    <?php foreach ($dataDetailPenjualanLayanan as $sm) : ?>
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a href="<?= base_url(); ?>cs/updateDetailPenjualanLayanan/<?= $sm['id_detail_penjualan_jasa_layanan']; ?>" class="badge badge-primary mb-3" data-toggle="modal" data-target="#editSubMenuModal<?= $sm['id_detail_penjualan_jasa_layanan']; ?>">EDIT</a>
                                <a href="<?= base_url(); ?>cs/hapusDetailPenjualanLayanan/<?= $sm['id_detail_penjualan_jasa_layanan']; ?>" class="badge badge-danger mb-3">DELETE</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
    ...
    <div class="modal fade" id="editSubMenuModal<?= $sm['id_detail_penjualan_jasa_layanan']; ?>" tabindex="-1" role="dialog" aria-labelledby="#editSubMenuModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url(); ?>cs/updateDetailPenjualanLayanan/<?= $sm['id_detail_penjualan_jasa_layanan']; ?>" method="post">
