                    ...
                    <?php foreach ($dataDetailPenjualanProduk as $sm) : ?>
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a href="<?= base_url(); ?>cs/updateDetailPenjualanProduk/<?= $sm['id_detail_penjualan_produk']; ?>" class="badge badge-primary mb-3" data-toggle="modal" data-target="#editSubMenuModal<?= $sm['id_detail_penjualan_produk']; ?>">EDIT</a>
                                <a href="<?= base_url(); ?>cs/hapusDetailPenjualanProduk/<?= $sm['id_detail_penjualan_produk']; ?>" class="badge badge-danger mb-3">DELETE</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
    ...
    <div class="modal fade" id="editSubMenuModal<?= $sm['id_detail_penjualan_produk']; ?>" tabindex="-1" role="dialog" aria-labelledby="#editSubMenuModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url(); ?>cs/updateDetailPenjualanProduk/<?= $sm['id_detail_penjualan_produk']; ?>" method="post">
